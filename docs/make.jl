...
filenames = ["visualize_residuals"]
for filename in filenames
    Literate.markdown(joinpath(SCRIPT_DIR, filename * ".jl"), OUTPUT_DIR; execute=true)
end
makedocs(;
    modules=[BlochSpins],
    ...
    pages=[
        "Home" => "index.md",
        "Examples" => ["Visualize Residual Vector" => "generated/visualize_residuals.md"],
    ],
